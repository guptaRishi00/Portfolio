  ...
  return (
    <footer className="py-10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            ...
            <p className="text-sm text-gray-400">
              &copy; {currentYear} Jitender Giri. All rights reserved.
            </p>
          </motion.div>
        ...
        >
          <p>
            Made with <FaHeart className="inline text-red-500 mx-1" /> using React, TypeScript, Tailwind CSS, and Framer Motion
          </p>
        </motion.div>
      </div>
    </footer>
